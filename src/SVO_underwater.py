...
from PointCloudRecorder import PointCloudRecorder
from utils import *
...
Proj1 = [[612.52727122, 0., 799.55836578, 0.],
         ...
         [0., 0., 1., 0.]]
Proj2 = [[6.12527271e+02, 0.00000000e+00, 7.99558366e+02, -1.66242662e+03],
         [0.00000000e+00, 6.12527271e+02, 6.04130826e+02, 0.00000000e+00],
         [0.00000000e+00, 0.00000000e+00, 1.00000000e+00, 0.00000000e+00]]

# underwater camera with housing
Proj1 = [[1423.3641415037725, 0., 950.24365234375, 0.],
         [0., 1423.3641415037725, 412.27730560302734, 0.],
         [0., 0., 1., 0.]]
Proj2 = [[1423.3641415037725, 0., 950.24365234375, -34748.051420600103],
         [0., 1423.3641415037725, 412.27730560302734, 0.],
         [0., 0., 1., 0.]]
...
recorder = PointCloudRecorder(save_interval=5)
total_dps = 0
diff = 10
...
for frm in range(startFrame + 1, endFrame + 1, diff):
    ...
    if plotTrajectory:
        ...
        color = (frm * 255 / (endFrame - startFrame), 255 - frm * 255 / (endFrame - startFrame), 0)
        cv2.circle(traj, (draw_x, draw_y), 1,
                   color, -1)
        # cv2.circle(traj, (draw_x, draw_y), 1, (255, 255, 255), 1)
        recorder.add_point(translation, color)
        if total_dps % 10 == 0:
            recorder.save_point_cloud()
